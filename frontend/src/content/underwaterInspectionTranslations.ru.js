export const UNDERWATER_INSPECTION_TRANSLATIONS_RU = {
    ...
    "Hull Defect Detection":
        "Обнаружение дефектов корпуса",
    ...
    "The mission of Underwater Inspection AI is to improve underwater technical inspection by making defect detection faster, more consistent and more intelligent, while supporting safer maintenance decisions for ships, yachts and marine infrastructure.":
        "Миссия Underwater Inspection AI — улучшить подводную техническую инспекцию, сделав обнаружение дефектов более быстрым, последовательным и интеллектуальным, поддерживая более безопасные решения по обслуживанию судов, яхт и морской инфраструктуры."
};
