...
export const seoConfig = {
  '/': {
    ...
    ogImage: `${BASE_URL}/favicon-falcon-eye-v3.png`,
    ogType: 'website',
    twitterTitle: 'Golden Dragon AI Platform',
    twitterDescription: 'Advanced multimodal AI systems and intelligent orchestration.',
    twitterImage: `${BASE_URL}/favicon-falcon-eye-v3.png`,
  },
  '/chat': {
    title: 'AI Project Assistant & Strategy Chat | Golden Dragon AI',
    description: 'Chat with an interactive AI assistant delivering intelligent guidance, responsive support, and practical AI-powered recommendations in real time.',
    canonical: `${BASE_URL}/chat`,
    ogTitle: 'Dragon Chat - AI Assistant',
    ogDescription: 'Chat with an advanced AI assistant for intelligent solutions and automation.',
    ogImage: `${BASE_URL}/favicon-falcon-eye-v3.png`,
    ogType: 'website',
